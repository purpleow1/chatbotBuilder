...
export const PLAN_CONFIGS: Record<SubscriptionPlan, PlanConfig> = {
  free: {
    ...
    name: "Free",
    price: "$0",
    description: "Validate one assistant with a small knowledge base.",
    botLimit: 1,
    documentLimit: 5,
  ...
  pro: {
    ...
    name: "Pro",
    price: "$29",
    description: "Launch polished assistants for customers, teams, or partners.",
    botLimit: 10,
    documentLimit: 100,
  ...
  business: {
    ...
    name: "Business",
    price: "$99",
    description: "Scale knowledge assistants across departments and websites.",
    botLimit: 30,
    documentLimit: 500,
